...
> subagent-driven.
>
> **Sema S0 (foundations) is DONE (2026-07-26).** See the roadmap's Sema row above for what shipped
> and the gate command. **Next: S1 — declarations & scopes**; plan to be written just-in-time.
