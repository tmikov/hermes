...
SHERMES_EXPORT SH_ATTRIBUTE_NORETURN void _sh_throw(SHRuntime *shr, SHLegacyValue value);

/// Throw a TypeError with the given message.
/// \param message will be converted to a string and used as the error message.
SHERMES_EXPORT SH_ATTRIBUTE_NORETURN void _sh_throw_type_error(SHRuntime *shr, SHLegacyValue *message);
...
SHERMES_EXPORT SH_READNONE int32_t
