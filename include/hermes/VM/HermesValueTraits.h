...
HERMES_VM_GCOBJECT(JSWebAssemblyInstance);
HERMES_VM_GCOBJECT(JSWebAssemblyMemory);
HERMES_VM_GCOBJECT(JSWebAssemblyModule);
HERMES_VM_GCOBJECT(JSWebAssemblyTable);
HERMES_VM_GCOBJECT(JSWebAssemblyGlobal);
HERMES_VM_GCOBJECT(JSWebAssemblyTag);
HERMES_VM_GCOBJECT(JSWebAssemblyException);
HERMES_VM_GCOBJECT(JSWeakRef);
HERMES_VM_GCOBJECT(FinalizationRecord);
HERMES_VM_GCOBJECT(JSFinalizationRegistry);
