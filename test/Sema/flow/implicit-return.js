...
// CHECK-NEXT:%function.2 = function(): %union.4
...
// CHECK-NEXT:            Decl %d.6 'f2' Var : %function.3
// CHECK-NEXT:            Decl %d.7 'f3' Var : %function.3
// CHECK-NEXT:            Decl %d.8 'f4' Var : %function.3
// CHECK-NEXT:            Decl %d.9 'f5' Var : %function.3
// CHECK-NEXT:            Decl %d.10 'f6' Var : %function.3
// CHECK-NEXT:            Decl %d.11 'f7' Var : %function.3
// CHECK-NEXT:            Decl %d.12 'f8' Var : %function.3
