...
;; REQUIRES: wasm
;; RUN: %wat2wasm %s -o %t.wasm && %hermesc --wasm -emit-binary -out %t.hbc %t.wasm 2>/dev/null && %hermes -Xhermes-internal-test-methods %S/e2e-escapable-float-param-driver.js_ -- %t.hbc | %FileCheck --match-full-lines %s
