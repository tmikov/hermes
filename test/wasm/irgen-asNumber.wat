...
;; Test that asNumber() inserts UnionNarrowTrustedInst to narrow :any → :number
...
;; variables are untyped in the IR, so asNumber() must insert
;; UnionNarrowTrustedInst before the value can be used by FAddInst.
...
;; CHECK: scope %VS0 [global_0: any, retBufI: any, retBufF: any, closure_0: any]
;; CHECK-EMPTY:
...
;; CHECK-NEXT:   %7 = UnionNarrowTrustedInst (:number) %6: any
