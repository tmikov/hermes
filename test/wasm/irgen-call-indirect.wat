...
;; The expected type is the interned id for this signature, loaded from
;; the frame; a module-local index would not be comparable across modules.
;; CHECK-NEXT: %[[TYPEID:.*]] = LoadFrameInst (:any) %[[SCOPE]]: environment, [%VS0.wasm_type_id_0]: any
;; CHECK-NEXT: %[[CLOSURE:.*]] = CallBuiltinInst (:any) [HermesBuiltin.wasmCallIndirect]: number, empty: any, false: boolean, empty: any, undefined: undefined, undefined: undefined, %[[FUNCS]]: any, %[[TYPES]]: any, %[[IDX]]: number, %[[TYPEID]]: any
;; CHECK-NEXT: %[[RESULT:.*]] = CallInst (:number) %[[CLOSURE]]: any, empty: any, false: boolean, empty: any, undefined: undefined, undefined: undefined
...
;; CHECK-NEXT: %[[CLOSURE2:.*]] = CallBuiltinInst (:any) [HermesBuiltin.wasmCallIndirect]: number, empty: any, false: boolean, empty: any, undefined: undefined, undefined: undefined, %[[FUNCS2]]: any, %[[TYPES2]]: any, %[[IDX2]]: number, %[[TYPEID2]]: any
;; CHECK-NEXT: %[[RESULT2:.*]] = CallInst (:number) %[[CLOSURE2]]: any, empty: any, false: boolean, empty: any, undefined: undefined, undefined: undefined, %[[ARG]]: number
;; CHECK-NEXT:                   BranchInst %BB1
...
;; CHECK-NEXT: %{{.*}} = CallInst (:number) %[[CLOSURE3]]: any
)
