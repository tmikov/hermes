...
;; RUN: %wat2wasm %s -o %t.wasm && %hermesc --wasm -emit-binary -out %t.hbc %t.wasm && ( ! %hermes -Xhermes-internal-test-methods -Xenable-untrusted-bytecode-from-js %S/instantiate-hbc.js_ -- %t.hbc 2>&1 ) | %FileCheck --check-prefix=RUNCHECK %s
