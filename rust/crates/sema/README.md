...
[`tests/sema_corpus/MANIFEST.md`](https://github.com/tmikov/hermes/blob/hermes-crates-v0.1.0/rust/crates/sema/tests/sema_corpus/MANIFEST.md)
and
[`tests/sema_corpus_parser/MANIFEST.md`](https://github.com/tmikov/hermes/blob/hermes-crates-v0.1.0/rust/crates/sema/tests/sema_corpus_parser/MANIFEST.md).
