...
// refuses to promote (`processDeclarations`, cpp:232-244: the binding table
...
// `extractDeclaredIdents`'s kind mapping (cpp:247-311): every let-like kind
// blocks, EXCEPT `ES5Catch` — `catch (e)` with a plain identifier param is
// explicitly skipped (cpp:212-216, ES14.0 B.3.4), so `e` there does NOT
