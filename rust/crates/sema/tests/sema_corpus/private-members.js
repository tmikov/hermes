...
// (SemanticResolver.cpp:2143-2260) declares, and every way the rest of the
// resolver reaches one:
//   - declarePrivateName (cpp:2033-2050): the '#'-prefixed Decl name comes
...
//     getter+setter pair upgrades to (cpp:2253-2257), where BOTH accessors'
//     identifiers bind to the SAME decl.
//   - resolvePrivateName (cpp:2052-2066) through visit(PrivateNameNode *)
//     (cpp:952-963) and through the MemberExpression branches
//     (cpp:1207-1295).
//   - visit(ClassPrivatePropertyNode *) (cpp:965-1006): a private field's
