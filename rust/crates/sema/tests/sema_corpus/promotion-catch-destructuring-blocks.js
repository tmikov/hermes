...
// mapping (ScopedFunctionPromoter.cpp:287-294): a DESTRUCTURING catch
// parameter (`catch ({ e })`) maps to `Decl::Kind::Catch`, not `ES5Catch`
// (that requires a plain `IdentifierNode` param, cpp:289-290). `Catch` IS
// let-like and is NOT the `ES5Catch` exemption (cpp:212-216: "only
